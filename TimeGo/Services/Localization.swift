...
final class L10n: ObservableObject {
    ...
    private static let zh: [String: String] = [
        ...
        "menu.heroIdleSubtitle": "解锁电脑后会自动开始，也可以手动开始。",
    ...
    private static let en: [String: String] = [
        ...
        "menu.heroIdleSubtitle": "Starts automatically when you unlock, or start manually.",
        ...
        "menu.statusIdle": "Flex time · auto-starts on unlock",
